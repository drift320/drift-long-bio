#THIS SRC MADE BY DEVIL
#MAIN CHANNEL -: @drift_ff_likee
#SECOND CHANNEL -: @drift_army_ff
#CONTACT -: @dg_drift
...
def perform_major_login(access_token, open_id):
    ...
    for platform_type in platforms:
        try:
            ...
            game_data.version_code = "2.124.1"
...
def combined_bio_upload():
    ...
    response_data = {
        "Credit": "DEVILHEX TEAM",
        "Join For More": "Telegram: @DeVilapis07",
